...
def train_model(model,trainX,batch_size,size,vecsize,epochs,context):
...
if __name__ == '__main__':
    ...
    [no_of_reviews, size, vecsize, output_shape] = np.load('../data/prepared/shape.npy')
    ...
    model = train_model(model, trainX, batch_size, size, vecsize, epochs, context)
